...
//! + `map_async` callback is Phase 1.5 work — until then, the pages
//! show the initial cleared state on CPU side while the GPU texture
//! holds the live distance field.
