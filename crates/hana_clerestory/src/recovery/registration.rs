...
mod tests {
    ...
    fn recovery_public_type_paths_are_stable() {
        assert_eq!(
            ...
            [
                "hana_clerestory::recovery::WindowRecovery",
                "hana_clerestory::recovery::WindowRecoveryPending",
                "hana_clerestory::recovery::WindowRecoveryAvailable",
                "hana_clerestory::recovery::RestoreWindow",
                "hana_clerestory::recovery::CancelWindowRecovery",
            ]
        );
    }
