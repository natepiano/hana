...
mod tests {
    ...
    fn reflected_type_paths_preserve_monitor_namespace() {
        assert_eq!(
            ...
            [
                "hana_clerestory::monitors::CurrentMonitor",
                "hana_clerestory::monitors::MonitorId",
                "hana_clerestory::monitors::MonitorIdentity",
                "hana_clerestory::monitors::MonitorInfo",
                "hana_clerestory::monitors::Monitors",
                "hana_clerestory::monitors::MonitorTopologyRevision",
                "hana_clerestory::monitors::MonitorConnected",
                "hana_clerestory::monitors::MonitorDisconnected",
            ]
        );
    }
