...
pub const EXAMPLE_ORBIT_CAM_PITCH_LIMIT: f32 = std::f32::consts::TAU / 3.0;
/// Canonical lower zoom/radius limit for examples that manually spawn an `OrbitCam`.
pub const EXAMPLE_ORBIT_CAM_ZOOM_LOWER_LIMIT: f32 = 1.0;
/// Canonical upper zoom/radius limit for examples that manually spawn an `OrbitCam`.
pub const EXAMPLE_ORBIT_CAM_ZOOM_UPPER_LIMIT: f32 = 8.0;
