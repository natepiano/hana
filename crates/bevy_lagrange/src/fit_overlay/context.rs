...
impl FitOverlayCameraContext {
    ...
    pub(super) const fn viewport_size(&self) -> Vec2 { self.logical_viewport.size() }
}

pub(super) fn effective_render_layers(render_layers: Option<&RenderLayers>) -> RenderLayers {
