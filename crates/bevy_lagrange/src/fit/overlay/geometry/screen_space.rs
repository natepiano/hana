...
pub enum MarginBalance {
    Balanced,
    Unbalanced,
}

/// Returns whether horizontal margins are balanced within the given tolerance.
pub const fn horizontal_balance(bounds: &ScreenSpaceBounds, tolerance: f32) -> MarginBalance {
...
pub const fn vertical_balance(bounds: &ScreenSpaceBounds, tolerance: f32) -> MarginBalance {
...
pub const fn boundary_edge_center(bounds: &ScreenSpaceBounds, edge: Edge) -> Option<(f32, f32)> {
...
pub const fn screen_edge_center(bounds: &ScreenSpaceBounds, edge: Edge) -> (f32, f32) {
    let (left_edge, right_edge, top_edge, bottom_edge) = screen_edges_normalized(bounds);
...
pub const fn margin_percentage(bounds: &ScreenSpaceBounds, edge: Edge) -> f32 {
