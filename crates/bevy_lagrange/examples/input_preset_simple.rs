...
fn main() {
    fairy_dust::sprinkle_example()
        ...
        .with_cube_spin::<SimpleMouseCube>()
...
// ═════════════════════════════════════════════════════════════════════════════
// SIMPLE MOUSE PRESET — OrbitCamInputMode::Preset(OrbitCamPreset::SimpleMouse).
// ═════════════════════════════════════════════════════════════════════════════
...
const PRESET: OrbitCamPreset = OrbitCamPreset::SimpleMouse;
