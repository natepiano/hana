...
// durations
pub(crate) const ANIMATE_FIT_DURATION_MS: u64 = 1200;
pub(crate) const LOOK_AT_DURATION_MS: u64 = 800;
pub(crate) const ORBIT_MOVE_DURATION_MS: u64 = 800;
...
pub(crate) const EVENT_LOG_HINT_BOTTOM_PX: f32 = 28.0;
pub(crate) const EVENT_LOG_PANEL_BOTTOM_PX: f32 = 72.0;
...
// ui layout
pub(crate) const CONFLICT_POLICY_HINT_BOTTOM_PX: f32 = 32.0;
pub(crate) const UI_FONT_SIZE: f32 = 13.0;
pub(crate) const UI_SCREEN_PADDING_PX: f32 = 12.0;
