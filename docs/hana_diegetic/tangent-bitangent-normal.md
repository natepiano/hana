...
- Text: `strip_tangent_dependent_maps` in
  `crates/hana_diegetic/src/render/panel_text/batching.rs` clears
...
- `crates/hana_diegetic/src/render/analytic_paths/analytic_path.wgsl`
- `crates/hana_diegetic/src/shaders/sdf_material_table.wgsl`
- `crates/hana_diegetic/src/render/material_table.wgsl`
