...
```bash
cargo bench -p hana_diegetic --bench layout_comparison --features bench_support -- --noplot
```

Raw layout-engine diagnostic benchmark:

```bash
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support -- --noplot
```

Retained public-panel benchmark:

```bash
cargo bench -p hana_diegetic --bench panel_perf --features bench_support -- --noplot
```
...
```bash
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support raw_status_panel_100_rows -- --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench panel_perf --features bench_support -- visual_only_rebuild --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support -- raw_status_panel_ --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support -- scale_tree_only --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support -- 'raw_status_panel_(100|500)_rows' --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench layout_comparison --features bench_support -- status_panel_100_rows --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench panel_perf --features bench_support -- panel_500_rows --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench panel_perf --features bench_support -- no_change_update --noplot
```
...
```sh
cargo bench -p hana_diegetic --bench layout_engine_raw --features bench_support -- layout_tree_diff --noplot
```
