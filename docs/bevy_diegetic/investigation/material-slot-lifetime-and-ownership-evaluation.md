...
- Text runs already use Bevy relationships:
  - `crates/bevy_diegetic/src/render/panel_text/relationship.rs`
...
- `crates/bevy_diegetic/src/render/material_slot_lifetime_probe.rs`
...
**Implemented probe:** `crates/bevy_diegetic/src/render/material_slot_lifetime_probe.rs`

**Verification:**

- `cargo nextest run -p bevy_diegetic material_slot_lifetime_probe` passed 6
  tests.
- `cargo clippy -p bevy_diegetic --all-targets` passed.
...
**Implemented probe extension:** `crates/bevy_diegetic/src/render/material_slot_lifetime_probe.rs`

**Verification:**

- `cargo nextest run -p bevy_diegetic material_slot_lifetime_probe` passed 9
  tests.
- `cargo clippy -p bevy_diegetic --all-targets` passed.
...
- `cargo nextest run -p bevy_diegetic material_slot_lifetime_probe` passed 12
  tests.
- `cargo clippy -p bevy_diegetic --all-targets` passed.
...
- `cargo nextest run -p bevy_diegetic material_slot_lifetime_probe` passed 15
  tests.
- `cargo clippy -p bevy_diegetic --all-targets` passed.
...
- `cargo nextest run -p bevy_diegetic material_slot_lifetime_probe` passed 21
  tests.
- `cargo clippy -p bevy_diegetic --all-targets` passed.
